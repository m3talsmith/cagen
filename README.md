...
| Option | Description |
|--------|-------------|
| prefix | The prefix to the final output (e.g. ca results in ca.pem and ca.crt) |
...
| key-size | The key size of the certificate. Must be divisible by 1024 |
| days-to-expire | When the certificate expires. Must be greater than or equal to 90 |